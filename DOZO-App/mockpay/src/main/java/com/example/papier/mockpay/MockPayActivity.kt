package com.example.papier.mockpay
...
private const val PAPIER_PACKAGE = "com.example.papier"
private const val PAPIER_ACTIVITY = "com.example.papier.MainActivity"
...
class MockPayActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MockPayScreen(
                ...
                onManualLaunch = {
                    launcher.launch(
                        Intent().setComponent(ComponentName(PAPIER_PACKAGE, PAPIER_ACTIVITY))
                    )
                },
                onForceStop = {
                    getSystemService(ActivityManager::class.java)
                        .killBackgroundProcesses(PAPIER_PACKAGE)
                    resultText = "Force-stopped $PAPIER_PACKAGE"
                    Log.i(TAG, "force-stop requested for $PAPIER_PACKAGE")
                }
            )
        }
    }
    ...
    private fun launchTransaction(action: String, status: String, reason: String?) {
        val intent = Intent().apply {
            component = ComponentName(PAPIER_PACKAGE, PAPIER_ACTIVITY)
            this.action = action
